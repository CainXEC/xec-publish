...
export default function PublishPaywallModal({
  ...
  return (
    ...
    >
      <div className="max-h-[90vh] w-full max-w-[22rem] overflow-y-auto rounded-xl border border-zinc-200 bg-white p-6 shadow-xl dark:border-zinc-700 dark:bg-zinc-900">
        <h2
