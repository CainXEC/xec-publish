...
const writerSteps = [
  ...
  },
  {
    ...
    body: 'Write your post, set an unlock price and publish by paying 100 XEC (payment helps to limit spam on the platform). Readers send XEC to unlock. You keep 94% of every payment.',
  },
]
