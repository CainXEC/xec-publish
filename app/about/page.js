      ...
      <main className="mx-auto max-w-2xl px-4 py-12 sm:px-6 sm:py-16">
        <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-10">
          ...
          <div className="mt-5 space-y-4 text-base leading-relaxed text-zinc-700 dark:text-zinc-300">
            <p>
              Proof Of Writing is a blogging platform that runs on crypto rails. All you need is
              an email to sign up to publish and an eCash wallet address to receive payments or to
              pay for content.
            </p>
            <p>
              Proof Of Writing never touches your funds and only charges a 6% platform fee. By
              comparison, Substack charges 10% plus an additional 3-6% deducted for credit card
              processing fees.
            </p>
            <p>
              By leveraging the eCash network, authors can charge as little or as much as they
              want for each article while keeping a greater percentage of their revenue.
            </p>
          </div>
          <div className="mt-8">
            <Link
