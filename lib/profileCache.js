...
/** The author's published articles (each carrying its per-story unlock/comment/
 *  earnings counts), cached viewer-neutral. `author` may be null (a handle-only
...
export async function getCachedArticleData({ accountId, author }) {
  ...
  return unstable_cache(
    async () => hydrateAuthorProfile(author),
