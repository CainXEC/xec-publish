...
// A mention is `@` + handle, but ONLY when it isn't glued to a preceding word
// char, `@`, or path char — so emails (`a@handle`) and URLs don't false-match.
const HANDLE_CHARS = 'A-Za-z0-9_'
const HANDLE_MAX = 15
const MENTION_SOURCE = `@[${HANDLE_CHARS}]{1,${HANDLE_MAX}}`
