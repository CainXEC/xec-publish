...
export async function loadAuthorProfileByUsername(rawUsername) {
  ...
  // No `earnings` (satoshis) on rows — unlike /api/posts, which uses get_unlock_earnings.
  // AuthorProfilePosts loads earnings client-side when the reader picks "Most Earned".
