...
//  sql/feed_engagement_signal.sql), which excludes gamed reactions before they're
//  ever tallied. This file only consumes the already-clean signal.
//
 ...
 */
export function rankFeedCandidates(posts, signals) {
  const list = posts ?? []
