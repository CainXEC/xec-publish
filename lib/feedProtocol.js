...
export const FEED_ACTION = Object.freeze({
  ...
  TIP: 13,
  // Forum creation — the paid creation fee (100% platform) commits sha256 of the
  // forum slug (its "proof of the name"), no target. Additive: older decoders
  // return null for it.
  FORUM: 14,
})
...
const CARRIES_HASH = new Set([
  ...
  FEED_ACTION.FORUM, // commits sha256(slug)
])
